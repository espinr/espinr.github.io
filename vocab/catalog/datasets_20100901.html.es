...
<html xml:lang="es" lang="es" xmlns:owl="http://www.w3.org/2002/07/owl#" xmlns:wot="http://xmlns.com/wot/0.1/" xmlns:cc="http://web.resource.org/cc/" xmlns:vann="http://purl.org/vocab/vann/" xmlns:dct="http://purl.org/dc/terms/" xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:skos="http://www.w3.org/2004/02/skos/core#" xmlns:xsd="http://www.w3.org/2001/XMLSchema#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:org="http://data.fundacionctic.org/vocab/comun/org#" xmlns="http://www.w3.org/1999/xhtml"><head><title>Vocabulario de Catálogos de Datasets</title><link rel="meta" type="application/rdf+xml" title="Vocabulario de Catálogos de Datasets" href="http://data.fundacionctic.org/vocab/catalog/datasets_20100901.rdf"/><link type="text/css" rel="stylesheet" media="all" href="http://datos.fundacionctic.org/recursos/2009/09/vocab.css"/></head><body><p><a href="http://www.fundacionctic.org/"><img src="http://datos.fundacionctic.org/recursos/2009/09/logo-ctic.gif" alt="Fundación CTIC"/></a></p><h1>Vocabulario de Catálogos de Datasets</h1><dl class="doc-info"><dt>Esta versión</dt><dd><a href="http://data.fundacionctic.org/vocab/catalog/datasets_20100901">http://data.fundacionctic.org/vocab/catalog/datasets_20100901</a> [<a href="http://data.fundacionctic.org/vocab/catalog/datasets_20100901.html">HTML</a>] [<a href="http://data.fundacionctic.org/vocab/catalog/datasets_20100901.rdf">RDF</a>]</dd><dt>La última versión</dt><dd><a href="http://data.fundacionctic.org/vocab/catalog/datasets#">http://data.fundacionctic.org/vocab/catalog/datasets#</a></dd><dt>Versión anterior</dt><dd><a href="http://data.fundacionctic.org/vocab/catalog/datasets_20100406">http://data.fundacionctic.org/vocab/catalog/datasets_20100406</a></dd><dt>Autor(es)</dt><dd>Martin Alvarez-Espinar (CTIC CT)</dd></dl><p class="rights">CTIC CT - Creative Commons 3.0 (BY-NC-SA)</p><p class="license">Este trabajo está bajo una <a href="http://creativecommons.org/licenses/by-nc-sa/3.0">licencia de Creative Commons</a>.</p><h2 id="toc">Tabla de Contenidos</h2><ul class="toc"><li><a href="#sec-introduction">Introducción</a></li><li><a href="#sec-namespace">Espacio de nombres</a></li><li><a href="#sec-terms">Resumen de los términos</a></li><li><a href="#sec-classes">Clases del vocabulario</a></li><li><a href="#sec-properties">Propiedades del vocabulario</a></li><li><a href="#sec-schema">Esquema RDF</a></li><li><a href="#sec-license">Licencia</a></li></ul><h2 id="sec-introduction">Introducción</h2><p class="comment">Este vocabulario se utiliza para modelar los catálogos de conjuntos de datos y las relaciones con los datasets</p><h2 id="sec-changes">Cambios desde la versión anterior</h2><ul><li><span class="date">2009-09-28</span> - primera publicación</li><li class="historyNote">2010-04-06 - cambio semántico de CTIC-CT:
      "Añadida una nueva propiedad ds:member"
    </li><li class="historyNote">2010-09-01 - cambio semántico de CTIC-CT:
      "Añadida propiedad ds:status sobre el estado de los catálogos (planificado, algunas cosas en la Web, datos estructurados publicados, etc.)"
    </li></ul><h2 id="sec-namespace">Espacio de nombres</h2><p>El URI para este vocabulario es</p><pre><code>http://data.fundacionctic.org/vocab/catalog/datasets#</code></pre><p>
...
member</code></pre><h2 id="sec-terms">Resumen de los términos</h2><p>Este vocabulario define
   ...
   <span class="attr">xmlns:xsd</span>="<span class="attrVal">http://www.w3.org/2001/XMLSchema#</span>" <span class="attr">xml:base</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog</span>"<span class="elem">&gt;</span>
  ...
  <span class="elem">&lt;owl:Ontology</span> <span class="attr">rdf:about</span>="<span class="attrVal"/>"<span class="elem">&gt;</span>
    <span class="elem">&lt;dc:identifier</span><span class="elem">&gt;</span>
      <span class="text">http://data.fundacionctic.org/vocab/catalog/datasets_20100901</span>
    ...
    <span class="elem">&lt;dcterms:replaces</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets_20100406</span>"<span class="elem">/&gt;</span>
    ...
    <span class="elem">&lt;dcterms:hasFormat</span><span class="elem">&gt;</span>
      <span class="elem">&lt;dctype:Text</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets_20100901.html</span>"<span class="elem">&gt;</span>
    ...
    <span class="elem">&lt;dcterms:hasFormat</span><span class="elem">&gt;</span>
      <span class="elem">&lt;dctype:Text</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets_20100901.rdf</span>"<span class="elem">&gt;</span>
        <span class="elem">&lt;dc:format</span><span class="elem">&gt;</span>
          <span class="elem">&lt;dcterms:IMT</span><span class="elem">&gt;</span>
    ...
    <span class="elem">&lt;skos:historyNote</span> <span class="attr">rdf:parseType</span>="<span class="attrVal">Resource</span>"<span class="elem">&gt;</span>
      <span class="elem">&lt;rdf:value</span> <span class="attr">xml:lang</span>="<span class="attrVal">en</span>"<span class="elem">&gt;</span><span class="text">New ds:member property added</span><span class="elem">&lt;/rdf:value&gt;</span>
      <span class="elem">&lt;rdf:value</span> <span class="attr">xml:lang</span>="<span class="attrVal">es</span>"<span class="elem">&gt;</span><span class="text">Añadida una nueva propiedad ds:member</span><span class="elem">&lt;/rdf:value&gt;</span>
      <span class="elem">&lt;dc:date</span><span class="elem">&gt;</span><span class="text">2010-04-06</span><span class="elem">&lt;/dc:date&gt;</span>
      <span class="elem">&lt;dc:creator</span><span class="elem">&gt;</span><span class="text">CTIC-CT</span><span class="elem">&lt;/dc:creator&gt;</span>
    ...
    <span class="elem">&lt;skos:historyNote</span> <span class="attr">rdf:parseType</span>="<span class="attrVal">Resource</span>"<span class="elem">&gt;</span>
      <span class="elem">&lt;rdf:value</span> <span class="attr">xml:lang</span>="<span class="attrVal">en</span>"<span class="elem">&gt;</span>
        <span class="text">New ds:status property added, about the status of the catalogs </span>
        <span class="text">(planned, some stuff on the Web, structured data published, etc.)</span>
      ...
      <span class="elem">&lt;rdf:value</span> <span class="attr">xml:lang</span>="<span class="attrVal">es</span>"<span class="elem">&gt;</span>
        <span class="text">Añadida propiedad ds:status sobre el estado de los catálogos </span>
        <span class="text">(planificado, algunas cosas en la Web, datos estructurados publicados, </span>
        <span class="text">etc.)</span>
      <span class="elem">&lt;/rdf:value&gt;</span>
      <span class="elem">&lt;dc:date</span><span class="elem">&gt;</span><span class="text">2010-09-01</span><span class="elem">&lt;/dc:date&gt;</span>
      <span class="elem">&lt;dc:creator</span><span class="elem">&gt;</span><span class="text">CTIC-CT</span><span class="elem">&lt;/dc:creator&gt;</span>
    <span class="elem">&lt;/skos:historyNote&gt;</span>
  ...
  <span class="elem">&lt;rdf:Property</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#member</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;rdfs:isDefinedBy</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#</span>"<span class="elem">/&gt;</span>
    ...
    <span class="elem">&lt;rdfs:range</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#Dataset</span>"<span class="elem">/&gt;</span>
    <span class="elem">&lt;rdfs:domain</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#Catalog</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;rdf:Property</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;rdfs:isDefinedBy</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;skos:ConceptScheme</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">&gt;</span>
  ...
  <span class="elem">&lt;skos:Concept</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status-announced</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;skos:inScheme</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;skos:Concept</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status-data</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;skos:inScheme</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;skos:Concept</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status-structuredData</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;skos:inScheme</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;skos:Concept</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status-nonProprietaryFormat</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;skos:inScheme</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;skos:Concept</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status-ldFormat</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;skos:inScheme</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">/&gt;</span>
  ...
  <span class="elem">&lt;skos:Concept</span> <span class="attr">rdf:about</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#status-linkedData</span>"<span class="elem">&gt;</span>
    <span class="elem">&lt;skos:inScheme</span> <span class="attr">rdf:resource</span>="<span class="attrVal">http://data.fundacionctic.org/vocab/catalog/datasets#statusScheme</span>"<span class="elem">/&gt;</span>
